...
using MySolutionWinWebForm.Module.Reports;

namespace MySolutionWinWebForm.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class MySolutionWinWebFormModule : ModuleBase {
        public MySolutionWinWebFormModule() {
            InitializeComponent();
        }

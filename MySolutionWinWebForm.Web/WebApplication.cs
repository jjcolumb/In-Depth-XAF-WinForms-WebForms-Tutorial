...
namespace MySolutionWinWebForm.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class MySolutionWinWebFormAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private MySolutionWinWebForm.Module.MySolutionWinWebFormModule module3;
        private MySolutionWinWebForm.Module.Web.MySolutionWinWebFormAspNetModule module4;
        ...
        public MySolutionWinWebFormAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void MySolutionWinWebFormAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new MySolutionWinWebForm.Module.Web.MySolutionWinWebFormAspNetModule();
            ...
            // securityModule1
            // 
            this.securityModule1.UserType = typeof(MySolutionWinWebForm.Module.BusinessObjects.ApplicationUser);
            // 
            ...
            // 
            // MySolutionWinWebFormAspNetApplication
            // 
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.MySolutionWinWebFormAspNetApplication_DatabaseVersionMismatch);
